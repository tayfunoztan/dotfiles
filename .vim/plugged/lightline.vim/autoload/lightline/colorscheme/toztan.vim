...
let s:p.inactive.right = [ ['white', 'gray2']]
let s:p.inactive.left = [ ['white', 'gray2']]
...
let s:p.inactive.middle = [ [ 'white', 'gray2' ] ]
...
let g:lightline#colorscheme#toztan#palette = lightline#colorscheme#fill(s:p)
